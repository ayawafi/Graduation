...
namespace Clinic_DbModel.Migrations
{
    ...
    [Migration("20230622214503_addnewfiledprop")]
    partial class addnewfiledprop
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clinic_DbModel.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Clinic_DbModel.Models.ChatMessage", b =>
                {
                    b.HasOne("Clinic_DbModel.Models.ApplicationUser", "ReceiverUser")
                        .WithMany()
                        .HasForeignKey("ReceiverUserId");

                    b.HasOne("Clinic_DbModel.Models.ApplicationUser", "SenderUser")
                        .WithMany()
